  ...
  return (
    <div className="absolute bottom-20 right-8 left-8">
      <div className="flex justify-center space-x-6">
        ...
        <button
          onClick={onCall}
          className="bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center space-x-2"
        >
