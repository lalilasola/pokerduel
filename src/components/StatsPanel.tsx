...
export default function StatsPanel({ stats }: StatsPanelProps) {
  return (
    <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="bg-black bg-opacity-30 backdrop-blur-sm rounded-xl p-6 border border-poker-gold border-opacity-20">
        <h3 className="text-white font-bold text-lg mb-4 flex items-center">
          <i className="fas fa-trophy text-poker-gold mr-2"></i>
          Game Stats
        </h3>
      ...
      <div className="bg-black bg-opacity-30 backdrop-blur-sm rounded-xl p-6 border border-poker-gold border-opacity-20">
        <h3 className="text-white font-bold text-lg mb-4 flex items-center">
          <i className="fas fa-coins text-poker-gold mr-2"></i>
          Chip Stack
        </h3>
        <div className="space-y-3">
          <div className="flex justify-between">
            <span className="text-gray-300">Current:</span>
            <span className="text-poker-gold font-bold text-xl">{stats.totalChips.toLocaleString()}</span>
          </div>
          <div className="flex justify-between">
      ...
      <div className="bg-black bg-opacity-30 backdrop-blur-sm rounded-xl p-6 border border-poker-gold border-opacity-20">
        <h3 className="text-white font-bold text-lg mb-4 flex items-center">
          <i className="fas fa-history text-poker-gold mr-2"></i>
          Session Info
        </h3>
